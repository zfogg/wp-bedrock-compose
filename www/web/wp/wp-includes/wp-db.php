...
class wpdb {
	...
	public function db_connect( $allow_bail = true ) {
		...
		if ( $this->use_mysqli ) {
			...
			//print_r(list($host, $port, $socket, $is_ipv6) = $host_data, true); echo '<br />';
			//var_dump($this->dbh); echo '<br />';
		//	var_dump($host); echo '<br />';
		//	var_dump($this->dbuser); echo '<br />';
		//	var_dump($this->dbpassword); echo '<br />';
		//	var_dump(null); echo '<br />';
		//	var_dump($port); echo '<br />';
		//	var_dump($socket); echo '<br />';
		//	var_dump($client_flags); echo '<br />';
			if ( WP_DEBUG ) {
